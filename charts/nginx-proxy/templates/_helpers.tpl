...
*/}}
{{- define "nginx-proxy.backendAddress" -}}
{{- if .Values.backend.namespace }}
{{- printf "%s.%s.svc.cluster.local:%d" .Values.backend.serviceName .Values.backend.namespace (int .Values.backend.servicePort) }}
{{- else }}
{{- printf "%s:%d" .Values.backend.serviceName (int .Values.backend.servicePort) }}
{{- end }}
{{- end }}
